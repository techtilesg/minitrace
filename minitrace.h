...
// It's recommended that you simply call mtr2_flush on a background thread
...
MINITRACE_EXPORT void mtr2_init(const char *json_file);
...
MINITRACE_EXPORT void mtr2_init_from_stream(void *stream);

// Shuts down minitrace cleanly, flushing the trace buffer.
MINITRACE_EXPORT void mtr2_shutdown(void);
...
MINITRACE_EXPORT const char *mtr2_pool_string(const char *str);
...
#define CNAME_NONE ""
#define CNAME_TERRIBLE "terrible"
...
#define MTR_BEGIN(c, n) internal_mtr2_raw_event(c, n, 'B', 0)
#define MTR_END(c, n) internal_mtr2_raw_event(c, n, 'E', 0)
#define MTR_END_FAILURE(c, n) internal_mtr2_raw_event_color(c, n, CNAME_TERRIBLE, 'E', 0)
#define MTR_SCOPE(c, n) MTRScopedTrace ____mtr2_scope(c, n)
#define MTR_SCOPE_LIMIT(c, n, l) MTRScopedTraceLimit ____mtr2_scope(c, n, l)

// Async events. Can span threads. ID identifies which events to connect in the view.
#define MTR_START(c, n, id) internal_mtr2_raw_event(c, n, 'S', (void *)(id))
#define MTR_STEP(c, n, id, step) internal_mtr2_raw_event_arg(c, n, 'T', (void *)(id), MTR_ARG_TYPE_STRING_CONST, "step", (void *)(step))
#define MTR_FINISH(c, n, id) internal_mtr2_raw_event(c, n, 'F', (void *)(id))

// Flow events. Like async events, but displayed in a more fancy way in the viewer.
#define MTR_FLOW_START(c, n, id) internal_mtr2_raw_event(c, n, 's', (void *)(id))
#define MTR_FLOW_STEP(c, n, id, step) internal_mtr2_raw_event_arg(c, n, 't', (void *)(id), MTR_ARG_TYPE_STRING_CONST, "step", (void *)(step))
#define MTR_FLOW_FINISH(c, n, id) internal_mtr2_raw_event(c, n, 'f', (void *)(id))
...
#define MTR_BEGIN_C(c, n, aname, astrval) internal_mtr2_raw_event_arg(c, n, 'B', 0, MTR_ARG_TYPE_STRING_CONST, aname, (void *)(astrval))
#define MTR_END_C(c, n, aname, astrval) internal_mtr2_raw_event_arg(c, n, 'E', 0, MTR_ARG_TYPE_STRING_CONST, aname, (void *)(astrval))
#define MTR_SCOPE_C(c, n, aname, astrval) MTRScopedTraceArg ____mtr2_scope(c, n, MTR_ARG_TYPE_STRING_CONST, aname, (void *)(astrval))

#define MTR_BEGIN_S(c, n, aname, astrval) internal_mtr2_raw_event_arg(c, n, 'B', 0, MTR_ARG_TYPE_STRING_COPY, aname, (void *)(astrval))
#define MTR_END_S(c, n, aname, astrval) internal_mtr2_raw_event_arg(c, n, 'E', 0, MTR_ARG_TYPE_STRING_COPY, aname, (void *)(astrval))
#define MTR_SCOPE_S(c, n, aname, astrval) MTRScopedTraceArg ____mtr2_scope(c, n, MTR_ARG_TYPE_STRING_COPY, aname, (void *)(astrval))

#define MTR_BEGIN_I(c, n, aname, aintval) internal_mtr2_raw_event_arg(c, n, 'B', 0, MTR_ARG_TYPE_INT, aname, (void*)(intptr_t)(aintval))
#define MTR_END_I(c, n, aname, aintval) internal_mtr2_raw_event_arg(c, n, 'E', 0, MTR_ARG_TYPE_INT, aname, (void*)(intptr_t)(aintval))
#define MTR_SCOPE_I(c, n, aname, aintval) MTRScopedTraceArg ____mtr2_scope(c, n, MTR_ARG_TYPE_INT, aname, (void*)(intptr_t)(aintval))
...
#define MTR_META_PROCESS_NAME(n) internal_mtr2_raw_event_arg("", "process_name", 'M', 0, MTR_ARG_TYPE_STRING_COPY, "name", (void *)(n))
#define MTR_META_THREAD_NAME(n) internal_mtr2_raw_event_arg("", "thread_name", 'M', 0, MTR_ARG_TYPE_STRING_COPY, "name", (void *)(n))
#define MTR_META_THREAD_SORT_INDEX(i) internal_mtr2_raw_event_arg("", "thread_sort_index", 'M', 0, MTR_ARG_TYPE_INT, "sort_index", (void *)(i))

#else //for MTR_ENABLED
...
#define MTR_SCOPE_FUNC_LIMIT_S(l) MTRScopedTraceLimit ____mtr2_scope(__FILE__, __FUNCTION__, l)
#define MTR_SCOPE_FUNC_LIMIT_MS(l) MTRScopedTraceLimit ____mtr2_scope(__FILE__, __FUNCTION__, (double)l * 0.000001)
...
public:
	MTRScopedTrace(const char *category, const char *name)
		...
		start_time_ = mtr2_time_s();
	}
	~MTRScopedTrace() {
		internal_mtr2_raw_event(category_, name_, 'X', &start_time_);
	}
...
// TODO: This will effectively call mtr2_time_s twice at the end, which is bad.
...
public:
	MTRScopedTraceArg(const char *category, const char *name, mtr2_arg_type arg_type, const char *arg_name, void *arg_value)
		: category_(category), name_(name) {
		internal_mtr2_raw_event_arg(category, name, 'B', 0, arg_type, arg_name, arg_value);
	}
	~MTRScopedTraceArg() {
		internal_mtr2_raw_event(category_, name_, 'E', 0);
	}
